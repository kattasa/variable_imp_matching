...
from other_methods.causalforest_dml import causalforest_dml_sample
...
start = time.time()
cate = causalforest_dml_sample(outcome='Y', treatment='T', df_train=df_train, sample=sample, covariates=covariates,
